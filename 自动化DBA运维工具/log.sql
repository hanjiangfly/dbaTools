...
--
-- Host: localhost    Database: db_log_wan_0001
-- ------------------------------------------------------
...
--
-- Table structure for table `t_log_appell`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_appell` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家ID',
  `TemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '称号模版ID',
  `Type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '称号类型',
  `IsLong` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否永久称号(0 否 1是)',
  `ExpirtDate` datetime NOT NULL DEFAULT '2999-01-01 00:00:00' COMMENT '称号过期时间',
  `CreateDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '日志记录时间',
  PRIMARY KEY (`Id`)
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户开背包格子日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_boss` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='江湖boss日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_bottle` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '当前时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='幸运魔罐日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户建筑升级日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_log_campfamreport`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_campfamreport` (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `FirstPlayer` varchar(100) NOT NULL DEFAULT '' COMMENT '第一名玩家|普能充能次数|高级充能次数|奖励物品|数量',
  `SecondPlayer` varchar(100) NOT NULL DEFAULT '' COMMENT '第二名玩家|普能充能次数|高级充能次数|奖励物品|数量',
  `ThirdPlayer` varchar(100) NOT NULL DEFAULT '' COMMENT '第三名玩家|普能充能次数|高级充能次数|奖励物品|数量',
  `CampId` tinyint(4) NOT NULL DEFAULT '0' COMMENT '阵营ID',
  `CurrentDate` datetime DEFAULT NULL COMMENT '日志时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='阵营圣光祝福前三奖励日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_campleaderfight`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_campleaderfight` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `CampId` int(11) DEFAULT '0' COMMENT '阵营ID',
  `AttackID` int(11) DEFAULT '0' COMMENT '攻方ID',
  `DefenceID` int(11) DEFAULT '0' COMMENT '防守方ID',
  `IsWin` tinyint(1) DEFAULT '0' COMMENT '是否胜利(1 胜利 0失败)',
  `Position` int(11) DEFAULT '0' COMMENT '挑战职位',
  `CreateDate` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '记录时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_challenge` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='单人挑战日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_champion`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_champion` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家ID',
  `Grades` smallint(4) NOT NULL DEFAULT '0' COMMENT '等级',
  `IsPass` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否通过（1通过 0 不通过）',
  `Point` int(11) NOT NULL DEFAULT '0' COMMENT '获取点数',
  `CreateDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '记录时间',
  `Index` smallint(4) NOT NULL DEFAULT '0' COMMENT '关卡',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_collect` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='采集任务(在任务中每采集一次就记录一次)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_conquer`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_conquer` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家ID',
  `Grades` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `StartDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '开始时间',
  `EndDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '结束时间',
  `TimeLength` int(11) NOT NULL DEFAULT '0' COMMENT '总时长（秒）',
  `OldWave` smallint(4) NOT NULL DEFAULT '0' COMMENT '上次最高层数',
  `NewWave` smallint(4) NOT NULL DEFAULT '0' COMMENT '当前完成层数',
  `IsNew` smallint(4) NOT NULL DEFAULT '0' COMMENT '是否今日新通关(1 是 0 否)',
  `Count` smallint(4) NOT NULL DEFAULT '0' COMMENT '获得钥匙数量',
  `CreateDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '记录时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='魔神祭坛日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_consortiaoffer` (
  ...
  KEY `Index_2` (`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='公会财富日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户信用点日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_day_active` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='玩家活跃值日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_dayreward` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='奖励大厅日志表(每抽奖一次有一条记录)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_dragon`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_dragon` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) DEFAULT '0' COMMENT '用户ID',
  `OpType` smallint(6) DEFAULT '0' COMMENT '操作类型',
  `DragonId` int(11) DEFAULT '0' COMMENT '战龙ID',
  `PreProperty` smallint(6) DEFAULT '0' COMMENT '之前属性（等级/阶数/星数）',
  `NowProperty` smallint(11) DEFAULT '0' COMMENT '当前属性（等级/阶数/星数）',
  `UseItemId` int(11) DEFAULT '0' COMMENT '使用物品ID',
  `UseItemCount` int(11) DEFAULT '0' COMMENT '使用物品数量',
  `IsAutoBuy` tinyint(1) DEFAULT '0' COMMENT '是否自动购买(1是 0否)',
  `UsePointCount` int(11) DEFAULT '0' COMMENT '钻石',
  `UseBindPointCount` int(11) DEFAULT '0' COMMENT '绑定钻石',
  `CreateDate` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '记录时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='战龙日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_drop` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`UserId`,`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='物品掉落日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='珍珑棋局';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_farm` (
  ...
  KEY `AK_Key_1` (`Id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户农场日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_geste` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户荣誉日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_gifttokendata` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户定绑元宝日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_guildwarinfo` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `StartTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '开始时间',
  `OverTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '结束时间',
  `WinConsortiaId` int(11) NOT NULL DEFAULT '0' COMMENT '胜方阵营ID',
  `LoseConsortiaId` int(11) NOT NULL DEFAULT '0' COMMENT '败方阵营ID',
  `WinSidePeople` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '联盟玩家数量',
  `LoseSidePeople` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '部落玩家数量',
  `WinType` tinyint(4) NOT NULL DEFAULT '0' COMMENT '战胜方式（0：时间到，1：攻破主图腾）',
  `LeagueRoyalty` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '联盟王权积分',
  `TribeRoyalty` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '部落王权积分',
  `SuccUserId` varchar(255) NOT NULL DEFAULT '' COMMENT '联盟排行榜获得奖励玩家ID',
  `LostUserId` varchar(255) NOT NULL DEFAULT '' COMMENT '部落排行榜获得奖励玩家ID',
  `Site` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1暗夜森林，2死亡峡谷，3自由草原，4无尽冰川，5圣光城',
  PRIMARY KEY (`Id`),
  KEY `StartTime` (`StartTime`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='公会战日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_hangup` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='修行崖日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_horcrux` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`UserId`,`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='魂器日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_iteminfo` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='物品操作日志'
...
CREATE TABLE `t_log_knight` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '当前日期',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_knight_compose` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '当前时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客图鉴日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_knight_drop` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '当前时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客各项礼物出现日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_knight_recruit` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='神秘侠客操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_knightinfo` (
  ...
  `CurrentDate` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_knightoperate`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_knightoperate` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) DEFAULT '0' COMMENT '用户ID',
  `OpType` smallint(4) DEFAULT '0' COMMENT '操作类型(升级、晋阶、战魂、纹章、传承)',
  `SonType` smallint(4) DEFAULT '0' COMMENT '操作子类型（升级：1升级 2一键升级）',
  `PreGrade` int(11) DEFAULT '0' COMMENT '操作前等级',
  `NowGrade` int(11) DEFAULT '0' COMMENT '操作后等级',
  `ItemTemplateId` int(11) DEFAULT '0' COMMENT '消耗物品ID',
  `UseItemCount` int(11) DEFAULT '0' COMMENT '使用数量',
  `IsAutoBuy` tinyint(1) DEFAULT '0' COMMENT '是否自动购买（1 是 0 否）',
  `UsePointCount` int(11) DEFAULT '0' COMMENT '使用钻石数量',
  `UseBindPointCount` int(11) DEFAULT '0' COMMENT '使用绑定钻石数量',
  `PreStar` int(11) DEFAULT '0' COMMENT '操作前星值',
  `NowStar` int(11) DEFAULT '0' COMMENT '操作后星值',
  `FromKnightId` int(11) DEFAULT '0' COMMENT '传承英雄ID',
  `ToKnightId` int(11) DEFAULT '0' COMMENT '被传承英雄ID',
  `CreateDate` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '操作时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_mail` (
  ...
  KEY `AK_Key_1` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='删除邮件记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_maindiscount` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`BuyDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城礼包销售日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_mysteryfresh` (
  ...
  KEY `Index_1` (`UserId`),
  KEY `Index_2` (`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户神秘商店刷新日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='新手进度';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_offer` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户贡献日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_onlineinfo` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`Time`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='用户在线信息记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_log_opboom`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_opboom` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `UserId` int(11) DEFAULT NULL COMMENT ' 玩家ID',
  `UpdateTime` datetime NOT NULL COMMENT '更新时间',
  `SumAdd` int(11) DEFAULT NULL COMMENT '增加数量',
  `SumLess` int(11) DEFAULT NULL COMMENT '消耗总和',
  `Boom` bigint(11) DEFAULT NULL COMMENT '剩余数量',
  PRIMARY KEY (`Id`,`UpdateTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='繁荣度消耗日志表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_openchant`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_openchant` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `UserId` int(11) NOT NULL COMMENT ' 玩家ID',
  `UpdateTime` datetime NOT NULL COMMENT '更新时间',
  `SumAdd` int(11) DEFAULT NULL COMMENT '增加数量',
  `SumLess` int(11) DEFAULT NULL COMMENT '消耗总和',
  `SonType` int(11) DEFAULT NULL COMMENT '附魔SonType',
  `OpType` tinyint(4) DEFAULT NULL COMMENT '附魔卡操作类型(0:激活 1升级)',
  PRIMARY KEY (`Id`,`UpdateTime`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='黄金消耗日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_log_ore`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_ore` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `UserId` int(11) NOT NULL COMMENT '用户ID',
  `CurrentDate` datetime NOT NULL COMMENT '操作时间',
  `ChangeType` int(11) NOT NULL COMMENT '消费子类型',
  `Ore` int(11) NOT NULL COMMENT '消费晶矿',
  `SpareOre` int(11) NOT NULL COMMENT '结余晶矿',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='玩家增加矿石消费日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_outside` (
  ...
  `CurrentDate` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外城操作记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_playerrob`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_playerrob` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) DEFAULT NULL,
  `TarUserId` int(11) DEFAULT NULL,
  `TarNickName` varchar(50) DEFAULT NULL,
  ...
  `LogDate` datetime DEFAULT NULL,
  `Gold` int(11) NOT NULL DEFAULT '0' COMMENT '黄金',
  `Ore` int(11) NOT NULL DEFAULT '0' COMMENT '魔晶',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='掠夺日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_property` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='个人属性值变化日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_quest` (
  ...
  `QuesType` tinyint(4) NOT NULL DEFAULT '0' COMMENT '任务类型(1:普通任务,2:悬赏任务)',
  `TemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '任务编号',
  `CurrentDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '操作时间',
  `CampId` int(11) NOT NULL DEFAULT '0' COMMENT '阵营ID',
  `Score` int(11) NOT NULL DEFAULT '0' COMMENT '获得积分',
  `CampScore` int(11) NOT NULL DEFAULT '0' COMMENT '阵营总积分',
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`CurrentDate`,`UserId`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='任务完成日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_recover` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资源追回日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_server` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`)
) ENGINE=InnoDB AUTO_INCREMENT=21464 DEFAULT CHARSET=utf8 COMMENT='服务器注册在线人数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_shop` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`UserId`,`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商店购买记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_singletoncampaign` (
  ...
  `CurrentDate` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='剧情副本操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_smithy` (
  ...
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `CurrentDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '操作时间',
  `Operation` int(11) NOT NULL DEFAULT '0' COMMENT '操作类型',
  `ItemName` varchar(50) NOT NULL DEFAULT '' COMMENT '物品名',
  `ItemId` int(11) NOT NULL DEFAULT '0' COMMENT '物品Id',
  `TemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '模板Id',
  `AddItem` varchar(255) NOT NULL DEFAULT '' COMMENT '附加物品',
  `BeginProperty` varchar(200) NOT NULL DEFAULT '' COMMENT '开始属性',
  `EndProperty` varchar(200) NOT NULL DEFAULT '' COMMENT '结束属性',
  `Result` int(11) NOT NULL DEFAULT '0' COMMENT '结果',
  `Money` int(11) NOT NULL DEFAULT '0' COMMENT '花费钱',
  `Point` int(11) NOT NULL DEFAULT '0' COMMENT '钻石',
  `IsAutoBuy` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否自动购买(1是 0 否)',
  `UseBindPointCount` int(11) NOT NULL DEFAULT '0' COMMENT '绑定钻石',
  `PreDecompose` varchar(255) NOT NULL DEFAULT '' COMMENT '分解前物品信息',
  `NowDecompose` varchar(255) NOT NULL DEFAULT '' COMMENT '分解完成后得到的物品信息',
  `InlayItemId` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌宝石ID',
  `PosInlayCount` int(11) NOT NULL DEFAULT '0' COMMENT '部位已开孔数量',
  `Pos` smallint(6) NOT NULL DEFAULT '0' COMMENT '部位',
  `PosGrade` smallint(6) NOT NULL DEFAULT '0' COMMENT '部位等级',
  `IsReplace` tinyint(1) NOT NULL DEFAULT '0' COMMENT '重铸时是否替换',
  `ItemCount` int(11) NOT NULL DEFAULT '0' COMMENT '物品数量',
  `ItemId2` int(11) NOT NULL DEFAULT '0' COMMENT '物品2',
  `ItemCount2` int(11) NOT NULL DEFAULT '0' COMMENT '物品2数量',
  KEY `AK_Key_1` (`Id`) USING BTREE,
  KEY `Index_1` (`CurrentDate`,`UserId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='铁匠铺日记';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_soul` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户侠魂日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='占星操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_starpoint` (
  ...
  KEY `AK_Key_1` (`Id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户星运日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_strategy` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户战魂日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_towertime` (
  ...
  KEY `Index_1` (`UserId`),
  KEY `Index_2` (`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='迷宫过关时间记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_type_item` (
  ...
  `CurrentDate` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='道具产出日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_upgrade` (
  ...
  KEY `AK_Key_1` (`Id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='用户升级日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_uservalue` (
  ...
  KEY `Index_1` (`UserId`),
  KEY `Index_2` (`CurrentDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户数值来源表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_warfield` (
  ...
  `CurrentDate` datetime DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='战场操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COMMENT='战场日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_watercrystal` (
  ...
  KEY `AK_Key_1` (`id`),
  KEY `Index_1` (`CurrentDate`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户水晶日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_wealth` (
  ...
  KEY `Index_1` (`CurrentDate`,`UserId`),
  KEY `Index_2` (`SonType`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户元宝消费日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_log_weay` (
  ...
  KEY `Index_1` (`CurrentDate`),
  KEY `UserId` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户体力日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_log_windmill`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_log_windmill` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `UserId` int(11) NOT NULL COMMENT '用户ID',
...
--
-- Dumping events for database 'db_log_wan_0001'
--

--
-- Dumping routines for database 'db_log_wan_0001'
--
...
-- Dump completed on 2016-07-14 21:02:53
