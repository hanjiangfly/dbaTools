...
--
-- Host: localhost    Database: db_game_wan_0001
-- ------------------------------------------------------
...
CREATE TABLE `sheet1` (
  ...
  `MasterType` varchar(255) DEFAULT NULL,
  `SonType` varchar(255) DEFAULT NULL,
  `SpecialType` varchar(255) DEFAULT NULL,
  `Grades` varchar(255) DEFAULT NULL,
  `PreTemplateId` varchar(255) DEFAULT NULL,
  `PreGradeCount` varchar(255) DEFAULT NULL,
  `NextTemplateId` varchar(255) DEFAULT NULL,
  `NeedPlayerGrade` varchar(255) DEFAULT NULL,
  `Index` varchar(255) DEFAULT NULL,
  `UseWay` varchar(255) DEFAULT NULL,
  `AppearTime` varchar(255) DEFAULT NULL,
  `AcceptObject` varchar(255) DEFAULT NULL,
  ...
  `BufferIds` varchar(255) DEFAULT NULL,
  `CountWay` varchar(255) DEFAULT NULL,
  `SkillRandom` varchar(255) DEFAULT NULL,
  `Crucial` varchar(255) DEFAULT NULL,
  `Priority` varchar(255) DEFAULT NULL,
  `CastTime` varchar(255) DEFAULT NULL,
  `DefaultTarget` varchar(255) DEFAULT NULL,
  `OwnRequirements` varchar(255) DEFAULT NULL,
  `EnemyRequirements` varchar(255) DEFAULT NULL,
  `QteTime` varchar(255) DEFAULT NULL,
  `CoolDown` varchar(255) DEFAULT NULL,
  `Description` varchar(255) DEFAULT NULL,
  `ProperType` varchar(255) DEFAULT NULL,
  `IsUseOnDead` varchar(255) DEFAULT NULL,
  `SkillItem` varchar(255) DEFAULT NULL,
  `SkillCount` varchar(255) DEFAULT NULL,
  `NextSkillTemplateId` varchar(255) DEFAULT NULL,
  `FightCapacity` varchar(255) DEFAULT NULL,
  `ExtraDesc` varchar(255) DEFAULT NULL,
  `TransformHeroId` varchar(255) DEFAULT NULL,
...
CREATE TABLE `t_s_activenumber` (
  ...
  PRIMARY KEY (`AwardID`),
  KEY `Index_1` (`ActiveId`,`UserID`) USING BTREE
...
CREATE TABLE `t_s_activetemplate` (
  ...
  `LastTime` smallint(6) NOT NULL DEFAULT '0' COMMENT '持续时间(分钟)(用于前端显示)',
...
CREATE TABLE `t_s_appell` (
  ...
  `IsSpecial` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1是特殊称号，0不是',
  PRIMARY KEY (`TemplateId`)
...
CREATE TABLE `t_s_avataorder` (
  ...
  PRIMARY KEY (`Order`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='常用avata统计';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_bookupgrade` (
  ...
  KEY `idx` (`TemplateId`) USING BTREE
...
CREATE TABLE `t_s_buildingtemplate` (
  ...
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB AUTO_INCREMENT=60111 DEFAULT CHARSET=utf8 COMMENT='建筑模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_campaign` (
  ...
  `Param1` int(11) DEFAULT '0' COMMENT '功能参数（展示英雄）',
...
CREATE TABLE `t_s_campaignbuffer` (
  ...
  `Decianti` int(11) NOT NULL DEFAULT '0' COMMENT '减抗',
  `AntiWater` int(11) NOT NULL DEFAULT '0' COMMENT '冰抗',
  `AntiFire` int(11) NOT NULL DEFAULT '0' COMMENT '火抗',
  `AntiWood` int(11) NOT NULL DEFAULT '0' COMMENT '土抗',
  `AntiLight` int(11) NOT NULL DEFAULT '0' COMMENT '光抗',
  `AntiDark` int(11) NOT NULL DEFAULT '0' COMMENT '暗抗',
  `AntiWind` int(11) NOT NULL DEFAULT '0' COMMENT '风抗',
  `Angry` int(11) NOT NULL COMMENT '怒气',
  `ReCrit` int(11) NOT NULL DEFAULT '0' COMMENT '韧性',
  `Wreck` int(11) NOT NULL DEFAULT '0' COMMENT '穿刺',
  `DataType` int(11) NOT NULL COMMENT '数据类型',
  `Description` varchar(200) NOT NULL COMMENT '描述',
  `Hp` int(11) NOT NULL DEFAULT '0' COMMENT '回复血量',
  `SpLimit` smallint(6) NOT NULL DEFAULT '0' COMMENT '怒气上限',
  `CartoonPath` varchar(50) DEFAULT NULL COMMENT '动画路径',
  PRIMARY KEY (`TemplateId`)
...
CREATE TABLE `t_s_campaigndata` (
  ...
  `CampaignId` int(11) NOT NULL DEFAULT '0' COMMENT '役战id',
  `NodeName` varchar(200) NOT NULL DEFAULT '' COMMENT '点节名字',
  `MasterType` int(11) NOT NULL DEFAULT '0' COMMENT '主类型',
  `SonType` int(11) NOT NULL DEFAULT '0' COMMENT '子类型',
  `RefreshSpeed` int(11) NOT NULL DEFAULT '0' COMMENT '恢复速度',
  `PreNodeIds` varchar(200) NOT NULL DEFAULT '0' COMMENT '前置节点',
  `Heros` varchar(200) NOT NULL DEFAULT '' COMMENT '英雄模板',
  `Soldiers` varchar(200) NOT NULL DEFAULT '' COMMENT 'Soldiers',
  `AI` varchar(1000) NOT NULL DEFAULT '' COMMENT 'AI',
  `Property1` int(11) NOT NULL DEFAULT '0' COMMENT '属性一',
  `Property2` int(11) NOT NULL DEFAULT '0' COMMENT '属性二',
  `Property3` int(11) NOT NULL DEFAULT '0' COMMENT '属性三',
  `Property4` int(11) NOT NULL DEFAULT '0' COMMENT '属性四',
  `HeroGP` int(11) NOT NULL DEFAULT '0' COMMENT '英雄获得经验',
  `Level` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `NextNodeIds` varchar(100) NOT NULL DEFAULT '' COMMENT '下一节点',
  `BattleType` int(11) NOT NULL DEFAULT '0' COMMENT '战斗类型',
  `StyleType` int(11) NOT NULL DEFAULT '0' COMMENT '样式类型',
  `MoveToNodeIds` varchar(100) NOT NULL DEFAULT '' COMMENT '传送目标点',
  `Formation` int(11) NOT NULL DEFAULT '0' COMMENT '部队的阵型',
  `PatrolPos` varchar(100) NOT NULL DEFAULT '' COMMENT '巡逻范围',
  `AttackTypes` int(11) NOT NULL DEFAULT '0' COMMENT '攻击类型',
  `NameColor` int(11) NOT NULL DEFAULT '0' COMMENT '名称颜色',
  `SizeType` int(11) NOT NULL DEFAULT '0' COMMENT '大小',
  `Toward` int(11) NOT NULL DEFAULT '0' COMMENT '朝向',
  `Resource` int(11) NOT NULL DEFAULT '0' COMMENT '资源类型',
  `BornPoints` varchar(100) NOT NULL DEFAULT '' COMMENT '出生点集合',
  `FixX` int(11) NOT NULL DEFAULT '0',
  `FixY` int(11) NOT NULL DEFAULT '0',
  ...
  `IsReport` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否可重复触发',
  `NodeState` int(11) NOT NULL DEFAULT '1' COMMENT '节点状态',
  `HandlerRange` int(11) NOT NULL DEFAULT '0' COMMENT '攻击范围',
  `IsChange` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否转换战斗背景',
  `CrossAi` varchar(1000) NOT NULL DEFAULT '' COMMENT '跨服ai',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_campemblem`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_campemblem` (
  `TemplateId` int(11) NOT NULL COMMENT '模板ID',
  `Grades` smallint(6) NOT NULL COMMENT '等级',
  `NeedCount` int(11) NOT NULL COMMENT '消耗阵营财富',
  `NeedGoddessGrade` smallint(6) NOT NULL COMMENT '所需女神等级',
  `NeedAltarLv` smallint(6) NOT NULL COMMENT '守卫神殿通关层数',
  `NeedWinNum` int(6) NOT NULL COMMENT '阵营战胜利次数',
  `Attack` int(11) NOT NULL COMMENT '攻击',
  `Defence` int(11) NOT NULL COMMENT '防御',
  `Live` int(11) NOT NULL COMMENT '生命值',
  `SkillMax` int(11) NOT NULL COMMENT '阵营技能学习上限',
  `SkillStr` varchar(50) NOT NULL DEFAULT '' COMMENT '特殊意志'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='阵营纹章配置表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_camptasktemp`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_camptasktemp` (
  `TaskId` int(11) NOT NULL COMMENT '任务ID',
  `Groups` tinyint(4) NOT NULL COMMENT '任务组(1阵营任务,2个人任务)',
  `Types` smallint(6) NOT NULL COMMENT '任务类型',
  `Stars` tinyint(4) NOT NULL COMMENT '任务星级',
  `Sort` tinyint(4) NOT NULL COMMENT '任务排序',
  `param1` int(11) NOT NULL COMMENT '任务参数1',
  `param2` int(11) NOT NULL COMMENT '任务参数2',
  `Title` varchar(20) NOT NULL COMMENT '任务标题',
  `TaskDesc` varchar(50) NOT NULL COMMENT '任务描述',
  `RewardMedal` smallint(6) NOT NULL COMMENT '奖励勋章',
  `RewardScore` smallint(6) NOT NULL COMMENT '奖励积分',
  `ExaCount` tinyint(4) NOT NULL COMMENT '竞速奖励个数',
  `ExaRewardMedal` smallint(6) NOT NULL COMMENT '额外奖励勋章',
  `ExaRewardScore` smallint(6) NOT NULL COMMENT '额外奖励勋章',
  PRIMARY KEY (`TaskId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='阵营悬赏任务模板表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_s_champion_battle_template`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_champion_battle_template` (
  `TemplateId` int(11) NOT NULL COMMENT '模板ID',
  `Index` int(11) NOT NULL DEFAULT '0' COMMENT '关卡索引',
  `PreTempId` int(11) NOT NULL DEFAULT '0' COMMENT '前置关卡ID',
  `NextTempId` int(11) NOT NULL DEFAULT '0' COMMENT '后置关卡ID',
  `TemplateName` varchar(20) NOT NULL DEFAULT '' COMMENT '模板名称',
  `HeroTempId` int(11) NOT NULL DEFAULT '0' COMMENT 'BOSS模板ID',
  `ArmyTempIds` varchar(50) NOT NULL DEFAULT '' COMMENT '战斗部队ID(关联sysarmy模板)',
  `Needfightcapacity` int(11) NOT NULL DEFAULT '0' COMMENT '推荐战斗力',
  `MapId` int(11) NOT NULL DEFAULT '0' COMMENT '地图ID',
  `IsChange` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否转换战斗背景',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='冠军的试炼关卡模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_s_collection`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_collection` (
  `TemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '模板Id(一个Id的收集只能完成一次)',
  `Type` smallint(6) NOT NULL DEFAULT '0' COMMENT '类型(1战龙碎片收集激活2物品碎片等,见常量类.CollectionType)',
  `Name` varchar(10) NOT NULL DEFAULT '' COMMENT '名称(用于客户端显示Tips)',
  `Desc` varchar(100) NOT NULL DEFAULT '' COMMENT '描述(用于客户端显示Tips)',
  `ComposeId` int(11) NOT NULL DEFAULT '0' COMMENT '合成的Id(如物品模板Id,战龙模板Id等)',
  `NeedId` int(11) NOT NULL DEFAULT '0' COMMENT '所需的碎片物品Id',
  `NeedCount` int(11) NOT NULL DEFAULT '0' COMMENT '所需的碎片物品个数(8的倍数)',
  `Pic1` varchar(30) NOT NULL DEFAULT '' COMMENT '收集进度的图片1(背包中NeedId物品个数<=NeedCount/4)',
  `Pic2` varchar(30) NOT NULL DEFAULT '' COMMENT '收集进度的图片2(背包中NeedId物品个数<=NeedCount/3)',
  `Pic3` varchar(30) NOT NULL DEFAULT '' COMMENT '收集进度的图片3(背包中NeedId物品个数<=NeedCount/2)',
  `Pic4` varchar(30) NOT NULL DEFAULT '' COMMENT '收集进度的图片4(背包中NeedId物品个数<=NeedCount)',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='碎片收集合成模板表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_combinationfashion`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_combinationfashion` (
  `Id` int(11) NOT NULL DEFAULT '0' COMMENT '组合ID',
  `Name` varchar(20) NOT NULL COMMENT '组合名',
  `Fashions` varchar(100) NOT NULL COMMENT '时装列表',
  `Attack` int(11) NOT NULL DEFAULT '0' COMMENT '攻击',
  `Defence` int(11) NOT NULL DEFAULT '0' COMMENT '防御',
  `Blood` int(11) NOT NULL DEFAULT '0' COMMENT '血量',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '套装等级',
  `WalkEffect` varchar(50) NOT NULL DEFAULT '' COMMENT '行走特效',
  `FightEffect` varchar(50) NOT NULL DEFAULT '' COMMENT '战斗特效',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='时装组合模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_crossmirrorheroinfo` (
  ...
  `TotalDecAnti` int(11) DEFAULT '0' COMMENT '减抗',
  `TotalAntiWater` int(11) DEFAULT '0' COMMENT '冰抗',
  `TotalAntiFire` int(11) DEFAULT '0' COMMENT '火抗',
  `TotalAntiWood` int(11) DEFAULT '0' COMMENT '土抗',
  `TotalAntiLight` int(11) DEFAULT '0' COMMENT '光抗',
  `TotalAntiDark` int(11) DEFAULT '0' COMMENT '暗抗',
  `TotalAntiWind` int(11) DEFAULT '0' COMMENT '风抗',
...
CREATE TABLE `t_s_crossmirrorsacredinfo` (
  ...
  `TotalAntiWater` int(11) DEFAULT '0' COMMENT '冰抗',
  `TotalAntiWood` int(11) DEFAULT '0' COMMENT '土抗',
  `TotalAntiWinder` int(11) DEFAULT '0' COMMENT '风抗',
...
--
-- Table structure for table `t_s_dragon`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_dragon` (
  `TemplateId` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '模板id',
  `DeciAnti` int(11) NOT NULL DEFAULT '0' COMMENT '减抗性',
  `AntiWater` int(11) NOT NULL DEFAULT '0' COMMENT '冰抗性',
  `AntiFire` int(11) NOT NULL DEFAULT '0' COMMENT '火抗性',
  `AntiWinder` int(11) NOT NULL DEFAULT '0' COMMENT '风抗性',
  `AntiSoil` int(11) NOT NULL DEFAULT '0' COMMENT '土抗性',
  `AntiLight` int(11) NOT NULL DEFAULT '0' COMMENT '光抗性',
  `AntiDark` int(11) NOT NULL DEFAULT '0' COMMENT '暗抗性',
  `ActiveItem` varchar(100) NOT NULL DEFAULT '' COMMENT '激活物品',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB AUTO_INCREMENT=602 DEFAULT CHARSET=utf8 COMMENT='战龙模板';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_dragon_anti`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_dragon_anti` (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键自增Id',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级(方便策划配置数据)',
  `Type` tinyint(4) NOT NULL DEFAULT '-1' COMMENT '0~6分别表示减抗冰火风土光暗',
  `Param1` int(11) NOT NULL DEFAULT '0' COMMENT '起始值(包含)',
  `Param2` int(11) NOT NULL DEFAULT '0' COMMENT '结束值(包含)',
  `NeedItem` varchar(200) NOT NULL DEFAULT '' COMMENT '当前范围培养一次所需物品和个数',
  `AddValue` int(11) NOT NULL DEFAULT '0' COMMENT '当前范围培养一次增加的抗性',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='战龙抗性培养模板表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_dragon_star`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_dragon_star` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键，供编辑器使用',
  `TemplateId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '神兽模板id',
  `TemplateName` varchar(20) NOT NULL DEFAULT '' COMMENT '名称',
  `Level` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '星级',
  `ActiveSkills` varchar(200) NOT NULL DEFAULT '' COMMENT '该星级主动技能',
  `PasiveSkills` varchar(200) NOT NULL DEFAULT '' COMMENT '该星级被动技能',
  `InitAnger` int(11) NOT NULL DEFAULT '0' COMMENT '初始怒气加成',
  `RoundAnger` int(11) NOT NULL DEFAULT '0' COMMENT '每回合怒气加成',
  `Crits` int(11) NOT NULL DEFAULT '0' COMMENT '暴击加成',
  `AntiParry` int(11) NOT NULL DEFAULT '0' COMMENT '穿刺加成',
  `NeedItem` varchar(100) NOT NULL DEFAULT '' COMMENT '每一次进化扣除的物品和个数',
  `NextGP` bigint(20) NOT NULL DEFAULT '0' COMMENT '升到下级所需经验(v0.5升星改为祝福值+进阶的方式，该字段可删除)',
  `GPAdd` int(11) NOT NULL DEFAULT '0' COMMENT '每个物品增加的经验',
  `Random` int(11) NOT NULL DEFAULT '0' COMMENT '培养暴击概率(百分比)',
  `RandomAdd` int(11) NOT NULL DEFAULT '0' COMMENT '暴击增加经验',
  `ExRandom` int(11) NOT NULL DEFAULT '0' COMMENT '高级暴击的概率',
  `ExRandomAdd` int(11) NOT NULL DEFAULT '0' COMMENT '高级暴击增加的经验',
  `ModelIcon` varchar(200) NOT NULL DEFAULT '' COMMENT '模型资源路径',
  `HeadIcon` varchar(200) NOT NULL DEFAULT '' COMMENT '头像图标路径',
  `Stage` int(11) NOT NULL DEFAULT '0' COMMENT '当前星级所属等阶',
  `BlessStep1` int(11) NOT NULL DEFAULT '0' COMMENT '祝福值界限1',
  `BlessStep2` int(11) NOT NULL DEFAULT '0' COMMENT '祝福值界限2',
  `BlessStepMax` int(11) NOT NULL DEFAULT '0' COMMENT '祝福值最大值',
  `BlessPercent` int(11) NOT NULL DEFAULT '0' COMMENT '直接升星概率',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `TemplateId, Level` (`TemplateId`,`Level`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COMMENT='战龙升星模板';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_dragon_talent`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_dragon_talent` (
  `Id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增Id',
  `TalentIndex` tinyint(4) NOT NULL DEFAULT '0' COMMENT '对应天赋(从1开始,每个天赋对应一个事件,如果对应多个,取Id较大的)',
  `EventType` int(11) NOT NULL DEFAULT '0' COMMENT '事件类型(从1开始,定好后对应事件不能变)',
  `EventParam` int(11) NOT NULL DEFAULT '0' COMMENT '该天赋开启事件的参数',
  `PasiveSkill` varchar(100) NOT NULL DEFAULT '' COMMENT '该天赋的被动技能',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `EventType` (`EventType`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='战龙天赋模板表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_dragon_upgrade`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_dragon_upgrade` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键，供编辑器使用',
  ...
  `Crits` int(11) NOT NULL DEFAULT '0' COMMENT '暴击加成',
  `AntiParry` int(11) NOT NULL DEFAULT '0' COMMENT '穿刺加成',
  `NextGP` bigint(20) NOT NULL DEFAULT '0' COMMENT '升到下级所需经验',
  `NeedItem` varchar(100) NOT NULL DEFAULT '' COMMENT '每一次培养扣除的物品和个数',
  `GPAdd` int(11) NOT NULL DEFAULT '0' COMMENT '每个物品增加的经验',
  `Random` int(11) NOT NULL DEFAULT '0' COMMENT '培养暴击概率(百分比)',
  `RandomAdd` int(11) NOT NULL DEFAULT '0' COMMENT '暴击增加经验',
  `ExRandom` int(11) NOT NULL DEFAULT '0' COMMENT '高级暴击的概率',
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COMMENT='战龙升级模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_dragonsoultemplate` (
  ...
  `OutDefence` int(11) NOT NULL DEFAULT '0' COMMENT '外功防御',
  `InAttack` int(11) NOT NULL DEFAULT '0' COMMENT '内功攻击',
  `SpeedValue` int(11) NOT NULL DEFAULT '0' COMMENT '速度值',
  `ForceHit` int(11) NOT NULL DEFAULT '0' COMMENT '暴击值',
  `ReCrit` int(11) NOT NULL DEFAULT '0' COMMENT '抗暴击值',
  `Wreck` int(11) NOT NULL DEFAULT '0' COMMENT '破击值',
  `Live` int(11) NOT NULL DEFAULT '0' COMMENT '生命',
  `Parry` int(11) NOT NULL DEFAULT '0' COMMENT '抗破击值',
  `Gold` int(11) NOT NULL DEFAULT '0' COMMENT '金币加成',
  `Boom` int(11) NOT NULL DEFAULT '0' COMMENT '繁荣度加成',
  `Ore` int(11) NOT NULL DEFAULT '0' COMMENT '矿石加成',
  `Rob` int(11) NOT NULL DEFAULT '0' COMMENT '掠夺每次获得金币',
  PRIMARY KEY (`TemplateId`)
...
CREATE TABLE `t_s_dropitem` (
  ...
  `Property1` varchar(50) NOT NULL DEFAULT '' COMMENT '属性1',
  `Property2` varchar(50) NOT NULL DEFAULT '' COMMENT '属性2',
  `Property3` varchar(50) NOT NULL DEFAULT '' COMMENT '属性3',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `t_s_dungeonevent` (
  ...
  `EventTitle` varchar(100) NOT NULL DEFAULT '' COMMENT '事件标题',
  `EventMsg` varchar(500) NOT NULL DEFAULT '' COMMENT '事件信息',
  `SonType` int(11) NOT NULL DEFAULT '0' COMMENT '事件类型',
  `OccurPlace` varchar(200) NOT NULL DEFAULT '' COMMENT '可出现位置',
  `Score` int(11) NOT NULL DEFAULT '0' COMMENT '积分',
  `HeroTemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '怪物模板id',
  `Param1` varchar(100) NOT NULL DEFAULT '' COMMENT '道具,数量,积分,概率',
  `Param2` varchar(100) NOT NULL DEFAULT '' COMMENT '道具,数量,积分,概率',
  `Param3` varchar(100) NOT NULL DEFAULT '' COMMENT '道具,数量,积分,概率',
  `Param4` varchar(100) NOT NULL DEFAULT '' COMMENT '道具,数量,积分,概率',
  `Param5` varchar(100) NOT NULL DEFAULT '' COMMENT '消耗的数量5,10,20,30',
  `Param6` varchar(100) NOT NULL DEFAULT '',
  `Area` tinyint(4) NOT NULL DEFAULT '0' COMMENT '事件属于地图上哪个区域',
  `MapIndex` tinyint(4) NOT NULL DEFAULT '0' COMMENT '哪张地图的事件',
  `NeedMobility` int(11) NOT NULL DEFAULT '0' COMMENT '触发事件所消耗的行动力',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `t_s_eldership` (
  ...
  `StepLv` smallint(6) NOT NULL DEFAULT '0' COMMENT '阶',
  `StarLv` smallint(6) NOT NULL DEFAULT '0' COMMENT '星级',
  ...
  `DragonHurtId` varchar(20) NOT NULL DEFAULT '' COMMENT '战龙伤害技能id',
  ...
  `HarmRates` int(11) NOT NULL DEFAULT '0' COMMENT '伤害率(除以1000=比率)',
  `Avata` varchar(50) NOT NULL DEFAULT '' COMMENT '形象'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_enchant`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_enchant` (
  `TemplateId` int(11) NOT NULL COMMENT '模板ID',
  `SonType` smallint(6) NOT NULL DEFAULT '0' COMMENT '附魔类型',
  `EnchantValue` int(11) NOT NULL DEFAULT '0' COMMENT '附魔值',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='附魔模板表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_enchantskill`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_enchantskill` (
  `SonType` smallint(6) NOT NULL DEFAULT '0' COMMENT '附魔类型',
  `EnchantValue` int(11) NOT NULL DEFAULT '0' COMMENT '附魔值',
  `SkillId` int(11) NOT NULL DEFAULT '0' COMMENT '附魔技能',
  PRIMARY KEY (`SonType`,`EnchantValue`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='附魔技能模板表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_enchanttemplate`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_enchanttemplate` (
  `TemplateId` int(11) NOT NULL COMMENT '附魔模版ID',
  `TemplateName` varchar(50) NOT NULL COMMENT '附魔名称',
  `SonType` int(11) NOT NULL DEFAULT '0' COMMENT '子类型',
  `Grades` tinyint(4) NOT NULL COMMENT '附魔等级',
  `Detail` varchar(200) NOT NULL COMMENT '附魔描述',
  ...
  `Live` int(11) NOT NULL DEFAULT '0' COMMENT '生命',
  `Parry` int(11) NOT NULL DEFAULT '0' COMMENT '抗破击值',
  `Quality` varchar(10) NOT NULL DEFAULT '' COMMENT '品质',
  `NeedGp` int(11) NOT NULL DEFAULT '0' COMMENT '升级所需经验',
  `Pos` tinyint(4) DEFAULT NULL COMMENT '部位类型(1 武器、2铠甲 腰带、3 戒指 饰品)',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_fashiontemplate` (
  ...
  `AddSpeedValue` int(11) NOT NULL DEFAULT '0' COMMENT '5星额外增加内功攻击',
  ...
  `FashionValues` int(11) NOT NULL DEFAULT '0' COMMENT '时装时尚值',
  PRIMARY KEY (`TemplateId`)
...
--
-- Table structure for table `t_s_hanguptemplate`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_hanguptemplate` (
  `TemplateId` smallint(6) NOT NULL COMMENT '挂机模板ID',
  `HangUpName` varchar(50) NOT NULL COMMENT '挂机模板名',
  `Types` tinyint(2) NOT NULL COMMENT '类型(0 普通挂机 1困难挂机)',
  `GradeLimit` smallint(6) DEFAULT '0' COMMENT '等级限制（普通）',
  `KnightCountLimit` smallint(6) DEFAULT '0' COMMENT '侠客数量限制（困难）',
  `FightCountLimit` int(11) DEFAULT '0' COMMENT '战力限制（困难）',
  `HangUpLimit` smallint(6) DEFAULT '0' COMMENT '挂机人数限制（困难）',
  `PreCampaignId` int(11) DEFAULT NULL COMMENT '前置通关副本（普通）',
  `Description` varchar(200) DEFAULT '""' COMMENT '描述',
  `FightBase` int(11) DEFAULT '0' COMMENT '战力基数（玩家侠客战力/战力基数）概率实现普通掉落与稀有掉落',
  `CommonDrop` int(11) DEFAULT '0' COMMENT '普通掉落ID',
  `RareDrop` int(11) DEFAULT '0' COMMENT '稀有掉落ID',
  `Thumbnail` varchar(100) DEFAULT '""' COMMENT '缩略图',
  `SceneGraph` varchar(100) DEFAULT '""' COMMENT '场景图',
  `SortSn` smallint(6) DEFAULT '0' COMMENT '排序号',
  `DropPreView` varchar(200) NOT NULL DEFAULT '' COMMENT '掉落预览 10001,10002 第一个是普通,第二个是稀有',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_heroai` (
  ...
  `BossStr` varchar(200) DEFAULT NULL COMMENT '召唤英雄',
...
CREATE TABLE `t_s_herobaseproperty` (
  ...
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB AUTO_INCREMENT=99999904 DEFAULT CHARSET=utf8 COMMENT='侠客基础属性';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_herostep` (
  ...
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB AUTO_INCREMENT=651 DEFAULT CHARSET=utf8 COMMENT='侠客进阶增加属性表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_herotemplate` (
  ...
  `Live` int(11) NOT NULL COMMENT '生命',
  `Speed` smallint(6) NOT NULL DEFAULT '0' COMMENT '速度值',
  ...
  `OutPutSource` smallint(6) DEFAULT NULL COMMENT '侠客出处',
...
CREATE TABLE `t_s_horcrux` (
  ...
  `OutDefence` int(11) NOT NULL DEFAULT '0' COMMENT '外功防御',
  `InAttack` int(11) NOT NULL DEFAULT '0' COMMENT '内功攻击',
  `InDefence` int(11) DEFAULT NULL COMMENT '速度（原内攻防御修改）',
  `ForceHit` int(11) NOT NULL DEFAULT '0' COMMENT '暴击值',
  `ReCrit` int(11) NOT NULL DEFAULT '0' COMMENT '抗暴击值',
  `Wreck` int(11) NOT NULL DEFAULT '0' COMMENT '破击值',
  `Live` int(11) NOT NULL DEFAULT '0' COMMENT '生命',
...
CREATE TABLE `t_s_itemtemplate` (
  ...
  `TemplateName` varchar(200) NOT NULL DEFAULT '' COMMENT '物品名称',
  ...
  `Parry` int(11) NOT NULL DEFAULT '0' COMMENT '格挡',
  `SpeedValue` int(11) NOT NULL DEFAULT '0' COMMENT '速度',
  ...
  `Property7` varchar(100) DEFAULT '' COMMENT '属性七',
  `Icon` varchar(200) DEFAULT '' COMMENT '资源路径',
  `Description` varchar(500) DEFAULT '' COMMENT '物品描述',
  `OutPutSource` varchar(200) DEFAULT '' COMMENT '产出',
  `Profile` int(11) NOT NULL COMMENT '物品品质',
  `SellGold` int(11) NOT NULL COMMENT '出售黄金价格',
  `DefaultSkill` varchar(200) NOT NULL DEFAULT '' COMMENT '默认技能',
  `Avata` varchar(200) DEFAULT '' COMMENT '形象',
...
CREATE TABLE `t_s_knight_card` (
  ...
  `Grades` tinyint(4) NOT NULL DEFAULT '0' COMMENT '建议等级',
  `Avata` varchar(200) NOT NULL DEFAULT '' COMMENT '形象',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='''侠客闯关-关卡配置';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_s_knight_medal`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_knight_medal` (
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级(1-10)',
  `NeedGp` bigint(20) NOT NULL DEFAULT '0' COMMENT '当前等级所需经验(总经验)',
  `NeedItem` int(11) NOT NULL DEFAULT '0' COMMENT '所需物品模板id',
  `NeedCount` int(11) NOT NULL DEFAULT '0' COMMENT '点击一次消耗物品个数',
  `StageItem` int(11) NOT NULL DEFAULT '0' COMMENT '进阶所需物品Id',
  `StageItemCount` int(11) NOT NULL DEFAULT '0' COMMENT '进阶所需物品个数',
  `AddGp` int(11) NOT NULL DEFAULT '0' COMMENT '点击一次增加的经验',
  `AddAtk` int(11) NOT NULL DEFAULT '0' COMMENT '增加AddGp的经验换算的攻击增加',
  `AddDef` int(11) NOT NULL DEFAULT '0' COMMENT '增加AddGp的经验换算的防御增加',
  `AddHp` int(11) NOT NULL DEFAULT '0' COMMENT '增加AddGp的经验换算的生命增加',
  `AddHurtRate` int(11) NOT NULL DEFAULT '0' COMMENT '增加AddGp的经验换算的伤害率增加',
  `CritRand` varchar(50) NOT NULL DEFAULT '' COMMENT '暴击参数(如2,100|5,30|10,10)',
  PRIMARY KEY (`Grade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客纹章模板表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_maindiscount` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商城折扣表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_mapnode` (
  ...
  `types` int(11) DEFAULT NULL COMMENT '类型',
  `nodeName` varchar(200) NOT NULL COMMENT '节点名称',
  `playerGrades` int(11) DEFAULT NULL COMMENT '等级',
  `taskId` smallint(6) DEFAULT '0' COMMENT '任务ID',
  `moduleName` varchar(100) DEFAULT NULL COMMENT '模块名称',
  `description` varchar(200) DEFAULT NULL COMMENT '描述',
  `optionName` varchar(100) DEFAULT NULL COMMENT '选项名',
  `picPath` varchar(200) DEFAULT NULL COMMENT '资源路径',
  PRIMARY KEY (`templateId`)
...
CREATE TABLE `t_s_pawntemplate` (
  ...
  `HighSkill` varchar(200) DEFAULT '""' COMMENT '高级技能',
  `HeroSkill` varchar(200) DEFAULT '""' COMMENT '给英雄加成技能',
...
CREATE TABLE `t_s_physic` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统节点数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_proxy` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='跨服代理商列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_questtemplate` (
  ...
  `StartDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '起始时间',
  `EndDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '结束时间',
...
--
-- Table structure for table `t_s_randomevent`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_randomevent` (
  `TemplateId` int(11) NOT NULL COMMENT '随机事件主键ID',
  `MasterType` smallint(6) NOT NULL DEFAULT '0' COMMENT '主类型',
  `SonType` smallint(6) NOT NULL DEFAULT '0' COMMENT '子类型',
  `Title` varchar(100) NOT NULL DEFAULT '' COMMENT '标题',
  `Detail` varchar(200) NOT NULL DEFAULT '' COMMENT '描述',
  `Rand` smallint(6) NOT NULL DEFAULT '0' COMMENT '概率',
  `Count` int(11) NOT NULL DEFAULT '0' COMMENT '同一活动最大随机总数',
  `Param1` int(11) NOT NULL DEFAULT '0' COMMENT '参数1(时间长度、阵营财富增加或扣减数)',
  `Param2` int(11) NOT NULL DEFAULT '0' COMMENT '参数2(备用扩展)',
  `Param3` varchar(200) NOT NULL DEFAULT '' COMMENT '参数3(备用扩展)',
  PRIMARY KEY (`TemplateId`,`MasterType`,`SonType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='随机事件配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_robottemplate` (
  ...
  `Param1` int(11) NOT NULL DEFAULT '0' COMMENT '扩展参数',
  PRIMARY KEY (`TemplateId`)
...
CREATE TABLE `t_s_sacredtemplate` (
  ...
  `AntiWater` int(11) NOT NULL DEFAULT '0' COMMENT '冰抗性',
  `AntiFire` int(11) NOT NULL DEFAULT '0' COMMENT '火抗性',
  `AntiWood` int(11) NOT NULL DEFAULT '0' COMMENT '土抗性',
  `AntiLight` int(11) NOT NULL DEFAULT '0' COMMENT '光抗性',
  `AntiDark` int(11) NOT NULL DEFAULT '0' COMMENT '暗抗性',
...
CREATE TABLE `t_s_skillbuffertemplate` (
  `Id` int(11) NOT NULL DEFAULT '0' COMMENT 'Id',
  `BufferName` varchar(200) NOT NULL DEFAULT '' COMMENT '名称',
  `AttackData` int(11) DEFAULT '0' COMMENT '攻击目标类型(增益/减益)',
  `AttackType` int(11) DEFAULT '0' COMMENT '伤害类型(英雄五个属性)',
  `AttackObject` int(11) DEFAULT '0' COMMENT '作用对象(单体/群体)',
  `ValidCount` int(11) DEFAULT '0' COMMENT '有效时间(回合数为单位)',
  `AttackWay` int(11) DEFAULT '0' COMMENT 'buffer作用时机',
  `AttackValue` int(11) DEFAULT '0',
  `Icon` varchar(200) DEFAULT '0',
  `ValuePercent` int(11) NOT NULL DEFAULT '0',
  `Random` int(11) NOT NULL DEFAULT '0' COMMENT 'buffer产生几率',
  `AddWay` int(11) DEFAULT '0' COMMENT 'buffer添加时机',
  `CountWay` int(11) DEFAULT '1' COMMENT '统计方式1-按回合,2-按作用次数',
  `AddEffect` varchar(200) NOT NULL DEFAULT '' COMMENT 'buff添加时特效',
  `ActionEffect` varchar(200) NOT NULL DEFAULT '' COMMENT 'buff作用时特效',
  `LastEffect` varchar(200) NOT NULL DEFAULT '' COMMENT 'buff持续时特效',
  ...
  `TalentEffIds` varchar(100) NOT NULL DEFAULT '' COMMENT '天赋影响ID',
  `BufferCd` int(11) NOT NULL DEFAULT '0' COMMENT 'BUFF冷却时间',
  `LimitValue` int(11) NOT NULL DEFAULT '0' COMMENT '上限值',
  `BufferEffCd` int(11) NOT NULL DEFAULT '0' COMMENT 'Buffer作用冷却时间',
  `CanEffect` tinyint(4) DEFAULT '0' COMMENT '是否生效0生效1推迟生效',
  `SkillBufferTips` varchar(100) NOT NULL DEFAULT '' COMMENT '技能tips',
  ...
  `BufferDes` int(11) NOT NULL DEFAULT '0' COMMENT 'buffer描述UI',
  `AddConditionType` int(11) NOT NULL DEFAULT '0' COMMENT '添加条件类型(添加时根据此类型判断是否能添加)',
  `AddConditionValue` int(11) NOT NULL DEFAULT '0' COMMENT '添加条件类型的参数',
  `AddConditionValue1` int(11) NOT NULL DEFAULT '0' COMMENT '添加条件类型的参数1',
  `HorcruxEffectIcon` int(11) NOT NULL DEFAULT '0' COMMENT '圣器Buffer效果图片Id',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `t_s_skillpropertytemplate` (
  ...
  `Antiwater` int(11) DEFAULT '0' COMMENT '神兽冰抗',
  `Antiwood` int(11) DEFAULT '0' COMMENT '神兽土抗',
  `Antifire` int(11) DEFAULT '0' COMMENT '神兽火抗',
  `Antilight` int(11) DEFAULT '0' COMMENT '神兽光抗',
  `Antidark` int(11) DEFAULT '0' COMMENT '神兽暗抗',
  `Antiattack` int(11) DEFAULT '0' COMMENT '神兽攻击',
  `CritHurtRatio` smallint(6) DEFAULT '0' COMMENT '暴击伤害系数',
  `ParryEffectRatio` smallint(6) DEFAULT '0' COMMENT '招架效果系数',
  `CritRates` smallint(6) DEFAULT '0' COMMENT '暴击率',
  `RecritRates` smallint(6) DEFAULT '0' COMMENT '暴击抵抗率',
  `ParryRates` smallint(6) DEFAULT '0' COMMENT '招架率',
  `WreckRates` smallint(6) DEFAULT '0' COMMENT '穿刺率',
...
CREATE TABLE `t_s_skilltemplate` (
  ...
  `SpecialType` tinyint(4) NOT NULL DEFAULT '0' COMMENT '技能特殊类型(如变身，召唤等需改变战斗节奏的技能,见DNKConsts.SkillSpecialType)',
  ...
  `TransformHeroId` int(11) NOT NULL DEFAULT '0' COMMENT 'Boss变身模板Id',
  PRIMARY KEY (`TemplateId`),
...
--
-- Table structure for table `t_s_skilltemplate_mastery`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_skilltemplate_mastery` (
  `MasterType` int(11) NOT NULL DEFAULT '0' COMMENT '技能系别(同技能模板的MasterType)',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `NeedItem` int(11) NOT NULL DEFAULT '0' COMMENT '升到下一级所需物品',
  `NeedCount` int(11) NOT NULL DEFAULT '0' COMMENT '升到下一级所需物品个数',
  `Stage` int(11) NOT NULL DEFAULT '0' COMMENT '阶段(1,2,3,4 进阶,大师,宗师,主宰)',
  `SkillId` int(11) NOT NULL DEFAULT '0' COMMENT '该阶段被动技能Id',
  PRIMARY KEY (`MasterType`,`Grade`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='技能专精模板表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_s_switch` (
  ...
  `IsHide` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0正常显示在中控，1不显示',
...
CREATE TABLE `t_s_sysarmytemplate` (
  ...
  `Heros` varchar(50) NOT NULL DEFAULT '' COMMENT '英雄模板ID及站位',
  `Soldiers` varchar(50) NOT NULL DEFAULT '' COMMENT '士兵模板ID及站位',
  `Knights` varchar(50) NOT NULL DEFAULT '' COMMENT '侠客模板ID及站位',
  PRIMARY KEY (`TemplateId`)
...
--
-- Table structure for table `t_s_tipstemplate`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_tipstemplate` (
  `id` int(11) NOT NULL COMMENT 'ID',
  `Message` varchar(200) NOT NULL COMMENT '消息内容',
  `types` smallint(6) NOT NULL DEFAULT '0' COMMENT '消息类型',
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `t_s_windmilltemplate`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_s_windmilltemplate` (
  `TemplateId` int(11) NOT NULL COMMENT '风车模版ID',
  `TemplateName` varchar(50) NOT NULL COMMENT '产出名称',
  `TemplateType` int(11) NOT NULL DEFAULT '0' COMMENT '种植类型',
  `OpenGrade` tinyint(4) NOT NULL DEFAULT '1' COMMENT '开放等级',
  `Detail` varchar(100) DEFAULT NULL COMMENT '描述',
  `TwoHour` int(11) NOT NULL DEFAULT '0' COMMENT '2小时产出',
  `FourHour` int(11) NOT NULL DEFAULT '0' COMMENT '4小时产出',
  `EightHour` int(11) NOT NULL DEFAULT '0' COMMENT '8小时产出',
  `ItemTemplateId` int(11) NOT NULL COMMENT '产出物品ID',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_bottlepass` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='魔罐信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_buildingorder` (
  ...
  `Param1` int(11) NOT NULL COMMENT '扩展字段(OrderType=1时指建筑的MasterType)',
...
--
-- Table structure for table `t_u_camps_battle_info`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_camps_battle_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键Id',
  `LeagueRoyalty` int(11) NOT NULL DEFAULT '0' COMMENT '联盟王权',
  `TribeRoyalty` int(11) NOT NULL DEFAULT '0' COMMENT '部落王权',
  `WinnerSide` tinyint(4) NOT NULL DEFAULT '0' COMMENT '全部打完后胜利方(0尚未打完,1联盟,2部落)',
  `BuildingBuff0` tinyint(4) NOT NULL DEFAULT '0' COMMENT '败方封地建筑收益加成，0无，1有',
  `CampsActBuff0` tinyint(4) NOT NULL DEFAULT '0' COMMENT '败方阵营活动收益加成，0无，1有',
  `PlayerKillBuff0` tinyint(4) NOT NULL DEFAULT '0' COMMENT '阵营战败方个人击杀积分收益加成，0无，1有',
  `CampsBattleAttrBuff` varchar(20) NOT NULL DEFAULT '1.0,1.0' COMMENT '阵营战败方全属性加成叠加倍数',
  ...
  `ResetTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '重置时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='阵营战信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_camps_battle_score_info`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_camps_battle_score_info` (
  `CampsId` tinyint(4) NOT NULL DEFAULT '0' COMMENT '阵营Id',
  `Index` tinyint(4) NOT NULL DEFAULT '0' COMMENT '战斗索引(1-5)',
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户Id',
  `NickName` varchar(50) NOT NULL DEFAULT '' COMMENT '用户昵称',
  `Job` tinyint(4) NOT NULL DEFAULT '0' COMMENT '职业',
  `Score` int(11) NOT NULL DEFAULT '0' COMMENT '积分',
  `IsWin` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否胜利(0还未打完,1失败,2胜利)',
  `BoxGot` tinyint(4) NOT NULL DEFAULT '0' COMMENT '宝箱是否领取(0未领取,1已领取);',
  `CreateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '创建时间',
  `UpdateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`CampsId`,`Index`,`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='阵营战积分表-战斗索引0表示周积分-UserId0表示阵营积分';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_camptask`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_camptask` (
  `CampId` tinyint(4) NOT NULL COMMENT '阵营ID',
  `TaskId` int(11) NOT NULL COMMENT '任务ID',
  `ExaCount` tinyint(4) NOT NULL COMMENT '竞速奖励领取个数',
  `FreshTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '刷新时间',
  `UpdateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '更新时间',
  `IsExist` tinyint(1) NOT NULL COMMENT '是否存在',
  `ExaUserId` int(11) NOT NULL DEFAULT '0' COMMENT '首杀玩家ID',
  `ExaNickName` varchar(20) NOT NULL COMMENT '首杀玩家昵称',
  PRIMARY KEY (`CampId`,`TaskId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='阵营悬赏任务信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_campusertask`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_campusertask` (
  `UserId` int(11) NOT NULL COMMENT '玩家ID',
  `TaskId` int(11) NOT NULL COMMENT '任务ID',
  `IsAdd` tinyint(1) NOT NULL COMMENT '是否接取',
  `IsCompleted` tinyint(1) NOT NULL COMMENT '是否完成',
  `AddTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '接取时间',
  `CompleteTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '完成时间',
  `IsExist` tinyint(1) NOT NULL COMMENT '是否存在',
  PRIMARY KEY (`UserId`,`TaskId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='阵营悬赏任务用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_champion_battle_info`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_champion_battle_info` (
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户Id',
  `PlayerHp` int(11) NOT NULL DEFAULT '0' COMMENT '玩家的剩余血量(百分比)',
  `BossHp` int(11) NOT NULL DEFAULT '0' COMMENT '当前Boss剩余血量(百分比)',
  `MaxBossHp` int(11) NOT NULL DEFAULT '0' COMMENT '当前Boss剩余血量(百分比)(最大关卡)',
  `KnightHpStr` varchar(200) NOT NULL DEFAULT '' COMMENT '英雄剩余血量(百分比)',
  `BossIndex` int(11) NOT NULL DEFAULT '0' COMMENT '当前打到的关卡索引',
  `MaxIndex` int(11) NOT NULL DEFAULT '0' COMMENT '历史最高关卡',
  `TotalPoint` int(11) NOT NULL DEFAULT '0' COMMENT '总点数',
  `GotPoint` int(11) NOT NULL DEFAULT '0' COMMENT '已领取阶段宝箱的点数',
  `BoxIndexStr` varchar(100) NOT NULL DEFAULT '' COMMENT '贡品宝箱索引(0,1,0,1,1,1,0,...0表示该位置未开,1已开);',
  `DragonId` int(11) NOT NULL DEFAULT '0' COMMENT '上阵战龙Id',
  `GridStr` varchar(200) NOT NULL DEFAULT '' COMMENT '阵型串(101,102,-1,105,108...-1表示主角)',
  `ResetTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '重置时间',
  `FinishQuestId1` varchar(400) NOT NULL DEFAULT '' COMMENT '历史已完成任务Id1(1-30关任务)，用于扫荡',
  `FinishQuestId3` varchar(400) NOT NULL DEFAULT '' COMMENT '历史已完成任务Id3(61-90关任务)，用于扫荡',
  `IsSweep` tinyint(4) NOT NULL DEFAULT '1' COMMENT '今日是否已扫荡',
  `FinishQuestId2` varchar(400) NOT NULL DEFAULT '' COMMENT '历史已完成任务Id2(31-60关任务)，用于扫荡',
  PRIMARY KEY (`UserId`),
  KEY `TotalPoint` (`TotalPoint`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='冠军的试炼用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_collection`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_collection` (
  `TemplateId` int(11) NOT NULL DEFAULT '0' COMMENT '模板Id',
  `Type` smallint(6) NOT NULL DEFAULT '0' COMMENT '类型(1战龙2物品)',
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户Id',
  `Finish` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否已完成(0未完成1已完成)',
  PRIMARY KEY (`TemplateId`,`UserId`),
  KEY `IX_t_u_collection_UserId` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='碎片收集合成用户表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_conquer`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_conquer` (
  `UserId` int(11) NOT NULL COMMENT '用户编号',
  `ConquerType` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 普通难度',
  `DayMaxRank` smallint(6) NOT NULL DEFAULT '0' COMMENT '当日最高层数',
  `RewardNum` smallint(4) NOT NULL DEFAULT '0' COMMENT '当日已领宝箱阶段',
  `HistoryMaxRank` int(11) NOT NULL DEFAULT '0' COMMENT '历史最高层数',
  `TribeBless` tinyint(4) NOT NULL DEFAULT '0' COMMENT '部落祝福 当日剩余购买数量',
  `SpiritBless` tinyint(4) NOT NULL DEFAULT '0' COMMENT '精灵祝福 当日剩余购买数量',
  `SanctuaryBless` tinyint(4) NOT NULL DEFAULT '0' COMMENT '圣堂祝福 当日剩余购买数量',
  `AngelBless` tinyint(4) NOT NULL DEFAULT '0' COMMENT '天使祝福 当日剩余购买数量',
  `TribeBlessCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '部落祝福 今日累计购买数量',
  `SpiritBlessCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '精灵祝福 今日累计购买数量',
  `SanctuaryBlessCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '圣堂祝福 今日累计购买数量',
  `AngelBlessCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '天使祝福 今日累计购买数量',
  `SignSite` int(11) NOT NULL DEFAULT '0' COMMENT '首通奖励领取位置',
  `UpdateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '更新时间',
  `BoxIndexStr` varchar(100) DEFAULT '' COMMENT '贡品宝箱索引(0,1,0,1,1,1,0,...0表示该位置未开,1已开);',
  PRIMARY KEY (`UserId`,`ConquerType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='极限挑战用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_consortia` (
  ...
  `ChairmanID` int(11) DEFAULT '0' COMMENT '会长编号',
  ...
  `Offer` int(11) NOT NULL COMMENT '阵营资源',
  `TotalOffer` int(11) NOT NULL COMMENT '阵营累计贡献值',
  ...
  `RewardScore` int(11) NOT NULL DEFAULT '0' COMMENT '今日悬赏积分',
  `LastResetTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次悬赏宝箱重置时间',
  `LastFreshTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次刷新时间',
  `GoddessLv` smallint(6) NOT NULL COMMENT '女神等级',
  `WarWinCount` int(6) NOT NULL COMMENT '阵营战胜利次数',
...
CREATE TABLE `t_u_consortiafam` (
  ...
  `WaterCount` int(11) DEFAULT '0' COMMENT '充能值',
...
CREATE TABLE `t_u_consortiauser` (
  ...
  `HeadPic` varchar(50) NOT NULL DEFAULT '' COMMENT '头像',
  `DutyID` smallint(6) NOT NULL COMMENT '职责',
  `DutyPos` smallint(6) NOT NULL DEFAULT '0' COMMENT '领袖位置',
  `ExistDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '退出公会时间',
  `DayOffer` int(11) NOT NULL DEFAULT '0' COMMENT '当天捐献',
  `LastOffer` int(11) NOT NULL DEFAULT '0' COMMENT '昨日贡献',
  `Resource` int(11) NOT NULL DEFAULT '0' COMMENT '个人资源',
  `Tenure` int(11) NOT NULL DEFAULT '0' COMMENT '任期',
  ...
  `LastChallengeDate` date NOT NULL DEFAULT '2000-01-01' COMMENT '上次挑战时间',
  `EmblemLevel` smallint(6) NOT NULL DEFAULT '0' COMMENT '纹章等级',
  `RewardCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '今日阵营挑战次数',
  `RewardScore` smallint(6) NOT NULL DEFAULT '0' COMMENT '今日积分',
  `RewardBoxState` smallint(6) NOT NULL DEFAULT '0' COMMENT '积分宝箱领取状态',
  `ResetTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次重置时间',
  `MuteCount` smallint(6) NOT NULL DEFAULT '0' COMMENT '禁言次数',
  `LastMuteTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次禁言别人时间',
  `UnMuteTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '解除禁言时间',
  `Property1` smallint(6) NOT NULL DEFAULT '0' COMMENT '特权1次数',
  `Property2` smallint(6) NOT NULL DEFAULT '0' COMMENT '特权2次数',
  `SkillLvStr` varchar(50) NOT NULL DEFAULT '0,0,0,0,0,0,0' COMMENT '阵营技能等级串',
  KEY `IX_t_u_consortiauser_UserId` (`UserId`)
...
CREATE TABLE `t_u_crossmirrorheroinfo` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跨服玩家战斗力排行榜';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_crossmirrorknightinfo` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跨服玩家出战侠客信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_crossmirrorsacredinfo` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跨服玩家出战神兽信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='探索用户数据';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_dragon_common_info`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_dragon_common_info` (
  `UserId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户Id',
  `InitAnger` int(11) NOT NULL DEFAULT '0' COMMENT '初始龙怒',
  `RoundAnger` int(11) NOT NULL DEFAULT '0' COMMENT '每回合回复龙怒',
  `Crits` int(11) NOT NULL DEFAULT '0' COMMENT '暴击',
  `AntiParry` int(11) NOT NULL DEFAULT '0' COMMENT '穿刺',
  `TalentSkills` varchar(200) NOT NULL DEFAULT '' COMMENT '天赋技能',
  `DeciAnti` int(11) NOT NULL DEFAULT '0' COMMENT '减抗性',
  `AntiWater` int(11) NOT NULL DEFAULT '0' COMMENT '冰抗性',
  `AntiFire` int(11) NOT NULL DEFAULT '0' COMMENT '火抗性',
  `AntiWinder` int(11) NOT NULL DEFAULT '0' COMMENT '风抗性',
  ...
  `UpdateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户战龙共用信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_dragon_special_info`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_dragon_special_info` (
  `Id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键Id',
  `UserId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户Id',
  `TemplateId` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '战龙模板Id',
  `Type` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '类型(1幼龙,2巨龙)(已弃用)',
  `Level` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '星级',
  `StarGp` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '当前经验(v0.5升星改为祝福值的形式，该字段表示祝福值)',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `GradeGp` int(11) NOT NULL DEFAULT '0' COMMENT '等级经验',
  `Status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态(0休息,1出战)',
  `InitAnger` int(11) NOT NULL DEFAULT '0' COMMENT '初始龙怒',
  `RoundAnger` int(11) NOT NULL DEFAULT '0' COMMENT '每回合回复龙怒',
  `Crits` int(11) NOT NULL DEFAULT '0' COMMENT '暴击(20160309 v0.4将穿刺属性改成了减抗，名称未改)',
  `AntiParry` int(11) NOT NULL DEFAULT '0' COMMENT '穿刺',
  `CreateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '创建时间',
  `UpdateTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `UserId, TemplateId` (`UserId`,`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户战龙特有信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_dungeon` (
  ...
  `IsPlay` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否已经进行过游戏',
  ...
  `BossBlood` int(11) unsigned NOT NULL DEFAULT '100' COMMENT '魔龙巢穴每层BOSS血量的百分比',
  `ProY` int(11) NOT NULL DEFAULT '0' COMMENT '上个位置的Y坐标',
  `ProX` int(11) NOT NULL DEFAULT '0' COMMENT '上个位置的X坐标',
  `CanReset` tinyint(1) NOT NULL DEFAULT '0' COMMENT '魔龙巢穴地图是否可以重置',
  `MapIndex` tinyint(4) NOT NULL DEFAULT '0' COMMENT '哪张地图的事件',
  PRIMARY KEY (`Id`),
  KEY `IX_t_u_dungeon_Userid` (`Userid`)
...
--
-- Table structure for table `t_u_enchant`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_enchant` (
  `UserId` int(11) NOT NULL COMMENT '玩家ID',
  `SonType` int(11) NOT NULL COMMENT '附魔ID',
  `Grades` tinyint(4) NOT NULL COMMENT '附魔等级',
  `Pos` tinyint(4) NOT NULL COMMENT '魂器装备的位置,-1表示未装备',
  `GP` int(11) NOT NULL COMMENT '经验值',
  `Index` int(11) NOT NULL COMMENT '位置 -1表示未装备',
  PRIMARY KEY (`UserId`,`SonType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_equipmentpos`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_equipmentpos` (
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家ID',
  `Pos` smallint(6) NOT NULL DEFAULT '0' COMMENT '位置',
  `IntensifyLv` smallint(6) NOT NULL DEFAULT '0' COMMENT '强化等级',
  `RefineLv` smallint(6) NOT NULL DEFAULT '0' COMMENT '精炼等级',
  `RefineProgress` smallint(6) NOT NULL DEFAULT '0' COMMENT '精炼进度',
  `JoinId1` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌位置1的物品id',
  `JoinId2` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌位置2的物品id',
  `JoinId3` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌位置3的物品id',
  `JoinId4` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌位置4的物品id',
  `JoinId5` int(11) NOT NULL DEFAULT '0' COMMENT '镶嵌位置5的物品id',
  `CurType1` int(11) NOT NULL DEFAULT '0' COMMENT '第一条属性的type',
  `CurValue1` int(11) NOT NULL DEFAULT '0' COMMENT '第一条属性的value',
  `CurType2` int(11) NOT NULL DEFAULT '0' COMMENT '第二条属性的type',
  `CurValue2` int(11) NOT NULL DEFAULT '0' COMMENT '第二条属性的value',
  `CurType3` int(11) NOT NULL DEFAULT '0' COMMENT '第三条属性的type',
  `CurValue3` int(11) NOT NULL DEFAULT '0' COMMENT '第三条属性的value',
  `CurType4` int(11) NOT NULL DEFAULT '0' COMMENT '第四条属性的type',
  `CurValue4` int(11) NOT NULL DEFAULT '0' COMMENT '第四条属性的value',
  PRIMARY KEY (`UserId`,`Pos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='装备部位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_fiefdomevent`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_fiefdomevent` (
  `Id` int(11) NOT NULL COMMENT '主键',
  `UserId` int(11) NOT NULL COMMENT '用户ID',
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_t_u_fiefdomevent_UserId` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='封地事件表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_fiefeventid`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_fiefeventid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_friendgroup` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_t_u_friendgroup_UserId` (`UserId`)
...
CREATE TABLE `t_u_gemmazeinfo` (
  ...
  `GemScoreYesterday` int(11) NOT NULL DEFAULT '0' COMMENT '昨日分数(用于重置时自动领取积分宝箱)',
...
CREATE TABLE `t_u_getarmypawnid` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='部队兵种ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getbuildingid` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='建筑Id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getdungeonid` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='获取自增地宫id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getdungeonmapid` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='获取自增地宫地图id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getfriendgroupid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='生成好友分组ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getguildwarid` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='获取公会战ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_gethorcruxjadeid` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='魂玉主键表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getmallitembuyid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='拍卖场竞拍记录ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getmallitemid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='拍卖场出售物品ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getredbagid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='红包主键ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_getsnsid` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='自增列ID';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_hangup`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_hangup` (
  `UserId` int(11) NOT NULL COMMENT '玩家ID',
  `Camp` smallint(4) DEFAULT '0' COMMENT '阵营',
  `IsFight` smallint(4) DEFAULT '0' COMMENT '是否战斗',
  `TotalFightingCapacity` int(11) DEFAULT '0' COMMENT '侠客总战力',
  `Grades` smallint(4) DEFAULT '0' COMMENT '玩家等级',
  `HangUpTemplateId` smallint(4) DEFAULT '0' COMMENT '挂机地图Id',
  `HangUpTypes` smallint(4) DEFAULT '0' COMMENT '挂机类型',
  `LastHangUpCoolTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '最后一次被驱逐时间',
...
CREATE TABLE `t_u_heroinfo` (
  ...
  `FastKey` varchar(100) NOT NULL DEFAULT '' COMMENT '技能快捷键',
...
CREATE TABLE `t_u_horcrux_jade` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_t_u_horcrux_jade_UserId` (`UserId`)
...
CREATE TABLE `t_u_iteminfo` (
  ...
  `RandomSkill1` varchar(50) NOT NULL DEFAULT '""' COMMENT '随机技能1',
  `RandomSkill2` varchar(50) NOT NULL DEFAULT '""' COMMENT '随机技能2',
  `RandomSkill3` varchar(50) NOT NULL DEFAULT '""' COMMENT '随机技能3',
  `IsIdentify` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否鉴定',
  PRIMARY KEY (`Id`),
...
CREATE TABLE `t_u_kingtowerboss` (
  ...
  PRIMARY KEY (`Id`),
  KEY `Index_1` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跨服战斗力排行榜（前20）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_kingtowerinfo` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='王者之塔用户挑战记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_knight_attr_item`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_knight_attr_item` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL DEFAULT '0',
  `KnightTempId` int(11) NOT NULL DEFAULT '0',
  `SonType` int(11) NOT NULL DEFAULT '0' COMMENT '类型(121,122,123,124同属性丹的sontype)',
  ...
  `ReharmRates` int(11) NOT NULL DEFAULT '0' COMMENT '免伤率',
  PRIMARY KEY (`Id`),
  KEY `UserId` (`UserId`,`KnightTempId`,`SonType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客小勋章属性表(有侠客传承功能，不能设置联合主键)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_knight_medal`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_knight_medal` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户Id',
  `KnightTempId` int(11) NOT NULL DEFAULT '0' COMMENT '侠客模板Id',
  `Gp` bigint(20) NOT NULL DEFAULT '0' COMMENT '经验',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `Attack` int(11) NOT NULL DEFAULT '0' COMMENT '攻击',
  `Defence` int(11) NOT NULL DEFAULT '0' COMMENT '防御',
  `Hp` int(11) NOT NULL DEFAULT '0' COMMENT '生命',
  `HurtRate` int(11) NOT NULL DEFAULT '0' COMMENT '伤害率',
  PRIMARY KEY (`Id`),
  KEY `UserId` (`UserId`,`KnightTempId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='侠客纹章信息表(有侠客传承功能，不能设置联合主键)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_knightinfo` (
  ...
  `SpeedValue` smallint(6) NOT NULL DEFAULT '0' COMMENT '速度值',
  `TotalDecAnti` int(11) DEFAULT '0' COMMENT '减抗',
  `TotalAntiWater` int(11) DEFAULT '0' COMMENT '冰抗',
  `TotalAntiFire` int(11) DEFAULT '0' COMMENT '火抗',
  `TotalAntiWood` int(11) DEFAULT '0' COMMENT '土抗',
...
CREATE TABLE `t_u_luckywheelpass` (
  ...
  `Msg` varchar(255) NOT NULL DEFAULT '' COMMENT '递传信息',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='幸运转盘信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_mallbuy` (
  ...
  KEY `IX_t_u_mallbuy_UserId` (`UserId`)
...
--
-- Table structure for table `t_u_module_resettime`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_module_resettime` (
  `Type` int(11) NOT NULL DEFAULT '0' COMMENT '功能模块类型',
  `Time` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次重置时间',
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='各功能模块重置时间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_mount` (
  ...
  `MountPower` int(11) NOT NULL DEFAULT '0' COMMENT '坐骑总战力',
  PRIMARY KEY (`UserId`)
...
CREATE TABLE `t_u_mountstar` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='坐骑升星用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_orderadore`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_orderadore` (
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家Id',
  `BeAdoreCount` int(11) NOT NULL DEFAULT '0' COMMENT '被崇拜次数',
  `AdoreCount` smallint(6) NOT NULL DEFAULT '0' COMMENT '崇拜次数',
  `AdoreTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '崇拜时间',
  `MaxOrderStr` varchar(100) NOT NULL DEFAULT '' COMMENT '上榜最高值',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='排行榜崇拜表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_playerext` (
  ...
  `Boom` int(11) DEFAULT NULL COMMENT '繁荣度当前经验',
  `RobSearchCount` smallint(6) DEFAULT '0' COMMENT '当日掠夺次数',
  `LastRobCoolTime` datetime DEFAULT NULL COMMENT '最后一次掠夺时间',
  `BoomYield` int(11) DEFAULT '0' COMMENT '繁荣度基础产量',
  `BoomGrade` int(6) DEFAULT '0' COMMENT '繁荣度等级',
  `OreYield` int(11) DEFAULT '0' COMMENT '矿石基础产量',
  `OreTotalCount` int(11) DEFAULT '0' COMMENT '当前玩家矿石总量',
  `OreResourceMax` int(11) DEFAULT '0' COMMENT '仓库矿石保护最大值',
  `GoldYield` int(11) DEFAULT '0' COMMENT '黄金基础产量',
  `LastCalcGoldTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '最后计算黄金时间',
  `LastCalcOreTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '最后计算晶矿时间',
  `LastCalcBoomTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '最后计算繁荣度时间',
  `LastHangUpCoolTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '最后一次被驱逐时间',
  `LastHangUpInfo` varchar(100) DEFAULT '' COMMENT '被驱逐后信息 玩家昵称|挂机地图ID',
  `LastHangUpCommonId` int(11) DEFAULT '0' COMMENT '最后一次进入的挂机普通地图ID',
  `HangUpTimeLength` int(11) NOT NULL DEFAULT '0' COMMENT '困难地图累积挂机时长（每天清零）',
  `HangUpDropTime` int(11) NOT NULL DEFAULT '0' COMMENT '自动挂机普通图累计时间，玩家在线时每5分钟清0，隔日零晨清0',
  `HangUpDiffDropTime` int(11) NOT NULL DEFAULT '0' COMMENT '自动挂机困难图累计时间，玩家在线时每5分钟清0，隔日零晨清0',
  `CampHangupGP` int(11) NOT NULL DEFAULT '0' COMMENT '阵营激活神晶挂机经验',
  `CommonChargeCount` smallint(6) NOT NULL DEFAULT '0' COMMENT '每日普通充能次数 隔日零晨清0',
  `CampChargeGP` int(11) NOT NULL DEFAULT '0' COMMENT '阵营充能获得经验',
  `SeniorChargeCount` smallint(6) NOT NULL DEFAULT '0' COMMENT '每日高级充能次数限制 隔日零晨清0',
  `HangUpCommonDrop` smallint(6) NOT NULL DEFAULT '0' COMMENT '累积普通地图掉落数量',
  `HangUpRareDrop` smallint(6) NOT NULL DEFAULT '0' COMMENT '累积困难地图掉落数量',
  `EnableSuit` int(11) NOT NULL DEFAULT '0' COMMENT '启用套装的ID',
  `ActivateSuitId` varchar(100) NOT NULL DEFAULT '' COMMENT '已经激活的套装列表',
  `FashionValues` int(11) NOT NULL DEFAULT '0' COMMENT '玩家时尚值',
  `FlareTimes` int(11) NOT NULL DEFAULT '0' COMMENT '购买照明弹的次数',
  `MobilityTimes` int(11) NOT NULL DEFAULT '0' COMMENT '购买行动力的次数',
  `LastAddMobilityTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '上次增加行动力的时间',
  `CurrentOrder` int(11) NOT NULL DEFAULT '0' COMMENT '魔龙巢穴当天排名',
  `Score` int(11) NOT NULL DEFAULT '0' COMMENT '魔龙巢穴当天积分',
  `LastResetTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '魔龙巢穴上次重置时间',
  `HelpTimes` tinyint(4) NOT NULL DEFAULT '0' COMMENT '协助次数',
  `InviteTimes` tinyint(4) NOT NULL DEFAULT '0' COMMENT '当天的邀请次数',
  `Flare` int(11) NOT NULL DEFAULT '0' COMMENT '照明弹',
  `Mobility` int(11) NOT NULL DEFAULT '0' COMMENT '行动力',
  `EDayPickup` int(11) NOT NULL DEFAULT '0' COMMENT '增加幸运抽奖当日已抽奖位置',
  `SevenPickUp` smallint(6) NOT NULL DEFAULT '0' COMMENT '签到7天累计领取数',
  `FourteenPickUp` smallint(6) NOT NULL DEFAULT '0' COMMENT '14天领取次数',
  `ThirtyPickUp` smallint(6) NOT NULL DEFAULT '0' COMMENT '30天领取次数',
  `DaySignSite` binary(255) DEFAULT NULL COMMENT '签到累计数据',
  `SignStartDate` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '创建时间',
  `SpecialAppellId` int(11) NOT NULL DEFAULT '0' COMMENT '特殊称号',
  `DragonsualGold` int(11) NOT NULL DEFAULT '0' COMMENT '爵位金币加成',
  `DragonsualBoom` int(11) NOT NULL DEFAULT '0' COMMENT '爵位繁荣度加成',
  `DragonsualOre` int(11) NOT NULL DEFAULT '0' COMMENT '爵位繁矿石加成',
  `DragonsualRob` int(11) NOT NULL DEFAULT '0' COMMENT '爵位掠夺每次获得金币',
  `EnchantFightCapacity` int(11) DEFAULT '0' COMMENT '附魔总战力',
  `PlayCartoonTimes` int(11) NOT NULL DEFAULT '0' COMMENT '副本播放动画次数',
  `BoomGradeSignSite` binary(15) DEFAULT NULL COMMENT '封地等级宝箱领取数据,每1级领一次',
  `CurrentSignIndex` tinyint(4) NOT NULL DEFAULT '0' COMMENT '当前封地繁荣度宝箱领取位置',
  `KnightBattleIndex` tinyint(4) NOT NULL DEFAULT '0' COMMENT '当前征服之路宝箱领取位置',
  `KnightBattleDragon` int(11) NOT NULL DEFAULT '0' COMMENT '征服之路战龙模板',
  `DivineBoxCollectCount` tinyint(4) NOT NULL DEFAULT '0' COMMENT '天降宝箱每天收集次数',
  PRIMARY KEY (`UserId`)
...
CREATE TABLE `t_u_playerjoin` (
  ...
  `HarmRates` int(11) NOT NULL DEFAULT '0' COMMENT '伤害率',
  `ReharmRates` int(11) NOT NULL DEFAULT '0' COMMENT '免伤率',
  `CurArm` varchar(50) NOT NULL DEFAULT '' COMMENT '武器',
  `CurCloth` varchar(50) NOT NULL DEFAULT '' COMMENT '衣服',
  `Parry` int(11) NOT NULL DEFAULT '0' COMMENT '格档',
  ...
  `Decianti` int(11) DEFAULT '0' COMMENT '减抗',
  `AntiWater` int(11) DEFAULT '0' COMMENT '冰抗',
  `AntiFire` int(11) DEFAULT '0' COMMENT '火抗',
  `AntiWood` int(11) DEFAULT '0' COMMENT '土抗',
  `AntiLight` int(11) DEFAULT '0' COMMENT '光抗',
  `AntiDark` int(11) DEFAULT '0' COMMENT '暗抗',
  `AntiWinder` int(11) DEFAULT '0' COMMENT '风抗',
  `CritHurtRatio` smallint(6) DEFAULT '0' COMMENT '暴击伤害系数',
  `ParryEffectRatio` smallint(6) DEFAULT '0' COMMENT '招架效果系数',
  `CritRates` smallint(6) DEFAULT '0' COMMENT '暴击率',
  `RecritRates` smallint(6) DEFAULT '0' COMMENT '暴击抵抗率',
  `ParryRates` smallint(6) DEFAULT '0' COMMENT '招架率',
  `WreckRates` smallint(6) DEFAULT '0' COMMENT '穿刺率',
  `SpeedValue` smallint(6) DEFAULT '0' COMMENT '速度',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户加成属性';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `t_u_playerrob`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_playerrob` (
  `UserId` int(11) NOT NULL,
  `Camp` smallint(6) NOT NULL COMMENT '阵营',
  `ExpireDate` datetime DEFAULT NULL COMMENT '到期时间',
  `State` mediumint(2) DEFAULT NULL COMMENT '状态(0 非战斗 1 战斗）',
  `TotalFightingCapacity` int(11) DEFAULT NULL COMMENT '总战力',
  `Grades` smallint(6) DEFAULT '0' COMMENT '玩家等级',
  `RobFailCount` smallint(6) DEFAULT '0' COMMENT '玩家连续掠夺失败次数',
  `IsFirstRob` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否第一次搜索掠夺',
  `HeadId` int(11) NOT NULL DEFAULT '0' COMMENT 'HeroTemplate英雄模版ID用于客户端显示头像',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='掠夺搜索缓存玩家信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_playertime` (
  ...
  `CamDungeonRewardStatus` varchar(1000) NOT NULL DEFAULT '851,0|852,0|853,0|854,0|855,0|856,0',
  `CampaignSite` varchar(9000) DEFAULT NULL COMMENT '通过的区域',
  `SingleBossReward` varchar(1000) NOT NULL DEFAULT '101,0|102,0|103,0|104,0|105,0|106,0',
...
CREATE TABLE `t_u_playorder` (
  ...
  `LastChallengeTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '王者竞技 挑战冷却',
  ...
  `HistoryMaxRank` int(11) NOT NULL DEFAULT '0' COMMENT '历史最高排名(不清除)',
  ...
  `ChangeFashionOrder` int(11) NOT NULL DEFAULT '0' COMMENT '时尚值改变值',
  ...
  `TotalFashionValue` int(11) NOT NULL DEFAULT '0' COMMENT '时尚值',
  `TotalFashionOrder` int(11) NOT NULL DEFAULT '0' COMMENT '时尚值排名',
  PRIMARY KEY (`UserId`),
...
--
-- Table structure for table `t_u_powercompare`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_powercompare` (
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '玩家Id',
  `HeadId` smallint(11) NOT NULL DEFAULT '0' COMMENT '头像ID',
  `NickName` varchar(20) NOT NULL DEFAULT '' COMMENT '昵称',
  `TotalPower` int(11) NOT NULL DEFAULT '0' COMMENT '总战力',
  `EquipmentPower` int(11) NOT NULL DEFAULT '0' COMMENT '装备战力',
  `KnihtPower` int(11) NOT NULL DEFAULT '0' COMMENT '侠客战力',
  `DragonPower` int(11) NOT NULL DEFAULT '0' COMMENT '战龙战力',
  `HorcruxPower` int(11) NOT NULL DEFAULT '0' COMMENT '魂器战力',
  `MountPower` int(11) NOT NULL DEFAULT '0' COMMENT '坐骑战力',
  `FashionPower` int(11) NOT NULL DEFAULT '0' COMMENT '时装战力',
  PRIMARY KEY (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='战力比拼表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_question` (
  ...
  KEY `IX_t_u_question_userid` (`UserId`)
...
CREATE TABLE `t_u_redbag` (
  ...
  `Rewards` varchar(200) NOT NULL COMMENT '红包领取信息',
  `RedbagType` smallint(6) NOT NULL COMMENT '红包类型 1 黄金红包  2 绑钻  3 钻石',
...
CREATE TABLE `t_u_richman` (
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_t_u_richman_UserId` (`UserId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='达成奖励领取状态';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `t_u_skill_mastery`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_skill_mastery` (
  `UserId` int(11) NOT NULL DEFAULT '0' COMMENT '用户Id',
  `MasterType` int(11) NOT NULL DEFAULT '0' COMMENT '技能体系(11,12,13,14)',
  `Grade` int(11) NOT NULL DEFAULT '0' COMMENT '等级',
  `Stage` int(11) NOT NULL DEFAULT '0' COMMENT '专精阶段(1,2,3,4)',
  PRIMARY KEY (`UserId`,`MasterType`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='技能专精用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_sumactivecondition` (
  ...
  PRIMARY KEY (`Id`),
  KEY `indx1` (`UserId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='精彩活动条件记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='临时排名';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_u_towerinfo` (
  ...
  `SignSite` int(11) NOT NULL DEFAULT '0' COMMENT '已领取通关阶段宝箱',
  PRIMARY KEY (`UserId`,`CampaignId`)
...
CREATE TABLE `t_u_userinfo` (
  ...
  `ChargeDate` timestamp NULL DEFAULT '2000-01-01 08:00:00' COMMENT '最近充值时间',
...
--
-- Table structure for table `t_u_windmill`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_u_windmill` (
  `UserID` int(11) NOT NULL,
  `NickName` varchar(50) NOT NULL COMMENT '昵称',
  `ItemTemplateID` int(11) NOT NULL COMMENT '种植的农作物ID(物品ID)',
  `PlantingTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '种植日期',
  `MatureTime` datetime NOT NULL DEFAULT '2000-01-01 00:00:00' COMMENT '成熟日期',
  `PlantType` tinyint(4) DEFAULT '0' COMMENT '种植类型（0 未定义 1、2小时 2、4小时 3、8小时）',
  `AccelerateCount` smallint(4) NOT NULL DEFAULT '0' COMMENT '加速次数',
  `StolenCount` smallint(4) NOT NULL DEFAULT '0' COMMENT '被偷次数',
  `CropState` smallint(4) DEFAULT '0' COMMENT '状态(0 未种植 1 生产状态)',
  `WaterCount` smallint(4) NOT NULL DEFAULT '0' COMMENT '当前充能数量',
  `TributeCount` smallint(4) NOT NULL DEFAULT '0' COMMENT '可收获朝贡数量',
  `LastTributeTime` datetime DEFAULT '2000-01-01 00:00:00' COMMENT '上次朝贡时间',
  `TodayTributeCount` smallint(4) NOT NULL DEFAULT '0' COMMENT '今日自已朝贡次数',
  `BributeBase` smallint(4) DEFAULT '0' COMMENT '当前朝贡基数',
  `CanObtain` int(11) NOT NULL DEFAULT '0' COMMENT '预计可获得产出',
  `BuildingGrades` varchar(50) DEFAULT NULL COMMENT '建筑等级',
  `IsTodayHarvest` tinyint(1) DEFAULT '0' COMMENT '今日是否收获',
  `WindMillGP` int(11) NOT NULL DEFAULT '0' COMMENT '风车经验',
  PRIMARY KEY (`UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE VIEW `view_u_playerinfo` AS SELECT 
 ...
 1 AS `Boom`,
 1 AS `RobSearchCount`,
 1 AS `LastRobCoolTime`,
 1 AS `BoomYield`,
 1 AS `BoomGrade`,
 1 AS `OreYield`,
 1 AS `OreTotalCount`,
 1 AS `GoldYield`,
 1 AS `LastCalcGoldTime`,
 1 AS `LastCalcOreTime`,
 1 AS `LastCalcBoomTime`,
 1 AS `EnableSuit`,
 1 AS `ActivateSuitId`,
 1 AS `FashionValues`,
 1 AS `HangUpDropTime`,
 1 AS `HangUpDiffDropTime`,
 1 AS `HangUpTimeLength`,
 1 AS `HangUpCommonDrop`,
 1 AS `HangUpRareDrop`,
 1 AS `CommonChargeCount`,
 1 AS `SeniorChargeCount`,
 1 AS `CampHangupGP`,
 1 AS `CampChargeGP`,
 1 AS `Mobility`,
 1 AS `Flare`,
 ...
 1 AS `DaySignSite`,
 1 AS `SignStartDate`,
 1 AS `SpecialAppellId`,
 1 AS `LastHangUpInfo`,
 1 AS `DragonsualGold`,
 1 AS `DragonsualBoom`,
 1 AS `DragonsualOre`,
 1 AS `DragonsualRob`,
 1 AS `PlayCartoonTimes`,
 1 AS `EnchantFightCapacity`,
 1 AS `LastHangUpCommonId`,
 1 AS `OreResourceMax`,
 1 AS `LastHangUpCoolTime`,
 1 AS `BoomGradeSignSite`,
 1 AS `CurrentSignIndex`,
 1 AS `KnightBattleIndex`,
 1 AS `KnightBattleDragon`,
 1 AS `DivineBoxCollectCount`,
 1 AS `TotalFashionValue`,
 1 AS `TotalFashionOrder`,
 1 AS `ChangeFashionOrder`,
 1 AS `HistoryMaxRank`,
 1 AS `LastChallengeTime`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `view_u_userandplayerinfo`
--

SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_u_userandplayerinfo` AS SELECT 
 1 AS `UserId`,
 1 AS `UserName`,
 1 AS `CreateDate`,
 1 AS `IsForbid`,
...
--
-- Dumping events for database 'db_game_wan_0001'
--

--
-- Dumping routines for database 'db_game_wan_0001'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_dungeon_update`()
begin
...
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_fashion_update`()
BEGIN
	DROP TEMPORARY TABLE IF EXISTS temp_order;
	CREATE TEMPORARY TABLE IF NOT EXISTS temp_order(objectid INT PRIMARY KEY,orderid INT);
	SET SESSION TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
	...
	(
		SELECT p.userid,p.TotalFashionValue,f.FashionValues FROM t_u_playorder AS p JOIN t_u_playerext AS f ON p.userid = f.userid
		WHERE f.FashionValues>0
	) a ORDER BY `FashionValues` DESC;
	UPDATE t_u_playorder,temp_order
	SET t_u_playorder.TotalFashionOrder=temp_order.orderid
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_fish_update`()
begin
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_force_update`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_gemmaze_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order(objectid int primary key,orderid int);
	 set session transaction isolation level read uncommitted;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_knight_order_update`()
begin
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_1_update`()
begin
	 drop temporary table if exists temp_order;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_2_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order
	 (	 objectid int primary key,
	 ...
	 set @i=0;
	 truncate table temp_order;
	 insert into temp_order(objectid,orderid,para1)
	   select a.userid,@i:=@i+1,totalfightingcapacity 
	   from (
		  select p.userid,p.totalfightingcapacity from t_u_playerinfo as p join t_u_userinfo as u on(p.userid = u.userid) 
	          where u.isforbid=0
		    and u.isinternal!=10
		    and p.grades>=30
	 ...
	 SET @calc_count = 10;
	 SET @AvgFightPower = 0;
	 SELECT COUNT(1) INTO @calc_count FROM temp_order WHERE orderid >= 1 AND orderid <=@calc_count;
	 IF @calc_count > 10 OR @calc_count IS NULL OR @calc_count = 0 THEN
			SET @calc_count = 10;
	 END IF;
	 SELECT CEIL(SUM(para1)/@calc_count) INTO @AvgFightPower FROM temp_order WHERE orderid >= 1 AND orderid <=@calc_count;
	 IF @AvgFightPower IS NULL THEN
			SET @AvgFightPower = 70000;
   END IF;
   REPLACE INTO t_s_config(Id,ConfigName,ConfigValue,Description,IsClient) VALUES (1000000,"ServerTop10AvgFightPower",@AvgFightPower,"全服前10玩家的平均战斗力",0);
	 update `t_u_playorder`,temp_order
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_3_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order
	 (	 objectid int primary key,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_4_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order
	 (	 objectid int primary key,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_5_update`()
begin
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_6_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order
	 (	 objectid int primary key,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_orders_change_update`()
BEGIN
 SET SESSION TRANSACTION ISOLATION LEVEL READ UNCOMMITTED;
 ...
 b.ChangeFashionOrder = a.TotalFashionOrder - b.TotalFashionOrder;
 ...
 UPDATE t_u_playorder_history a JOIN t_u_playorder b ON a.userid = b.userid AND a.TotalFashionOrder = 0 AND b.TotalFashionOrder <> 0 SET b.ChangeFashionOrder = 99999999;
 SET SESSION TRANSACTION ISOLATION LEVEL REPEATABLE READ;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_redbag_update`()
begin
	 drop temporary table if exists temp_order;
	 create temporary table if not exists temp_order
	 (	 objectid int primary key,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_tower_update`()
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `proc_u_week_update`()
BEGIN
         DECLARE _nowDate DATE DEFAULT NOW(); 
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`htdba`@`localhost` PROCEDURE `sp_update_chargereward`(IN v_stepid INT,IN v_sql VARCHAR(1000))
BEGIN
...
/*!50013 DEFINER=`htdba`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_u_consortia` AS select `a`.`ConsortiaID` AS `ConsortiaID`,`a`.`ConsortiaName` AS `ConsortiaName`,`a`.`CreateDate` AS `CreateDate`,`a`.`ChairmanID` AS `ChairmanID`,`a`.`ChairmanName` AS `ChairmanName`,`a`.`Description` AS `Description`,`a`.`Placard` AS `Placard`,`a`.`Levels` AS `Levels`,`a`.`CurrentCount` AS `CurrentCount`,`a`.`Offer` AS `Offer`,`a`.`TotalOffer` AS `TotalOffer`,`a`.`FightPower` AS `FightPower`,`a`.`ShopLevel` AS `ShopLevel`,`a`.`StoreLevel` AS `StoreLevel`,`a`.`AltarLevel` AS `AltarLevel`,`a`.`IsExist` AS `IsExist`,`a`.`ActiveData` AS `ActiveData`,`a`.`Death` AS `Death`,`a`.`GroupPlacard` AS `GroupPlacard`,`a`.`AltarDate` AS `AltarDate`,`a`.`AltarState` AS `AltarState`,ifnull(`b`.`GradeOrder`,0) AS `GradeOrder`,ifnull(`b`.`CurrentLevels`,0) AS `CurrentLevels`,ifnull(`b`.`CurrentFightPower`,0) AS `CurrentFightPower`,ifnull(`b`.`CurrentOffer`,0) AS `CurrentOffer`,ifnull(`b`.`FightPowerOrder`,0) AS `FightPowerOrder`,ifnull(`b`.`LastDayOffer`,0) AS `LastDayOffer`,ifnull(convert(`b`.`LastDayDate` using utf8),_utf8'2000-01-01') AS `LastDayDate`,ifnull(`b`.`LastDayOrder`,0) AS `LastDayOrder`,ifnull(`b`.`LastWeekOffer`,0) AS `LastWeekOffer`,ifnull(convert(`b`.`LastWeekDate` using utf8),_utf8'2000-01-01') AS `LastWeekDate`,ifnull(`b`.`LastWeekOrder`,0) AS `LastWeekOrder`,ifnull(`b`.`WarOrder`,0) AS `WarOrder`,ifnull(`b`.`ChangeGradeOrder`,0) AS `ChangeGradeOrder`,ifnull(`b`.`ChangeFightPowerOrder`,0) AS `ChangeFightPowerOrder`,`a`.`AltarMaxWaveNum` AS `AltarMaxWaveNum`,`a`.`ActiveValue` AS `ActiveValue`,`a`.`ConsortiaType` AS `ConsortiaType`,`a`.`RewardScore` AS `RewardScore`,`a`.`LastResetTime` AS `LastResetTime`,`a`.`LastFreshTime` AS `LastFreshTime`,`a`.`GoddessLv` AS `GoddessLv`,`a`.`WarWinCount` AS `WarWinCount` from (`t_u_consortia` `a` left join `t_u_consortiaorder` `b` on((`a`.`ConsortiaID` = `b`.`ConsortiaID`))) */;
...
--
-- Final view structure for view `view_u_userandplayerinfo`
--

/*!50001 DROP VIEW IF EXISTS `view_u_userandplayerinfo`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
/*!50001 SET character_set_client      = utf8 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`htdba`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_u_userandplayerinfo` AS (select `a`.`UserId` AS `UserId`,`a`.`UserName` AS `UserName`,`a`.`CreateDate` AS `CreateDate`,`a`.`IsForbid` AS `IsForbid`,`a`.`Site` AS `Site`,`a`.`IsOnline` AS `IsOnline`,`a`.`IsExist` AS `IsExist`,`a`.`IsInternal` AS `IsInternal`,`a`.`Uuid` AS `Uuid`,`b`.`NickName` AS `NickName`,`b`.`Point` AS `Point`,`b`.`Grades` AS `Grades`,`b`.`Right` AS `Right`,`b`.`Flag` AS `Flag`,`b`.`ReloginDate` AS `ReloginDate`,`b`.`State` AS `State`,`b`.`PlatType` AS `PlatType` from (`t_u_userinfo` `a` left join `t_u_playerinfo` `b` on((`a`.`UserId` = `b`.`UserId`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2016-07-14 21:02:42
